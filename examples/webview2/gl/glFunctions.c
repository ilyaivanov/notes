...
typedef void GlSwapControl(GLint time);
...
void InitFunctions()
{
    glGenBuffers = (GlGenBuffers *)GetGlProc("glGenBuffers");
    glBindBuffer = (GlBindBuffer *)GetGlProc("glBindBuffer");
    glBufferData = (GlBufferData *)GetGlProc("glBufferData");
    glCreateShader = (GlCreateShader *)GetGlProc("glCreateShader");
    glCompileShader = (GlCompileShader *)GetGlProc("glCompileShader");
    glShaderSource = (GlShaderSource *)GetGlProc("glShaderSource");
    glGetShaderiv = (GlGetShaderiv *)GetGlProc("glGetShaderiv");
    glGetShaderInfoLog = (GlGetShaderInfoLog *)GetGlProc("glGetShaderInfoLog");
    glCreateProgram = (GlCreateProgram *)GetGlProc("glCreateProgram");
    glAttachShader = (GlAttachShader *)GetGlProc("glAttachShader");
    glLinkProgram = (GlLinkProgram *)GetGlProc("glLinkProgram");
    glGetProgramiv = (GlGetProgramiv *)GetGlProc("glGetProgramiv");
    glGetProgramInfoLog = (GlGetProgramInfoLog *)GetGlProc("glGetProgramInfoLog");

    glUseProgram = (GlUseProgram *)GetGlProc("glUseProgram");
    glDeleteShader = (GlDeleteShader *)GetGlProc("glDeleteShader");

    glBindVertexArray = (GlBindVertexArray*)GetGlProc("glBindVertexArray");
    glVertexAttribPointer = (GlVertexAttribPointer*)GetGlProc("glVertexAttribPointer");
    glGenVertexArrays = (GlGenVertexArrays*)GetGlProc("glGenVertexArrays");
    glEnableVertexAttribArray = (GlEnableVertexAttribArray*)GetGlProc("glEnableVertexAttribArray");

    glGetUniformLocation = (GlGetUniformLocation*) GetGlProc("glGetUniformLocation");
    glUniform4f = (GlUniform4f*) GetGlProc("glUniform4f");
    glGenerateMipmap = (GlGenerateMipmap*) GetGlProc("glGenerateMipmap");
    glActiveTexture = (GlActiveTexture*) GetGlProc("glActiveTexture");

    glUniform1f = (GlUniform1f*)GetGlProc("glUniform1f");
    glUniform2f = (GlUniform2f*)GetGlProc("glUniform2f");
    glUniform3f = (GlUniform3f*)GetGlProc("glUniform3f");
    glUniform4f = (GlUniform4f*)GetGlProc("glUniform4f");
    glUniform1i = (GlUniform1i*)GetGlProc("glUniform1i");
    glUniform2i = (GlUniform2i*)GetGlProc("glUniform2i");
    glUniform3i = (GlUniform3i*)GetGlProc("glUniform3i");
    glUniform4i = (GlUniform4i*)GetGlProc("glUniform4i");
    glUniform1fv = (GlUniform1fv*)GetGlProc("glUniform1fv");
    glUniform2fv = (GlUniform2fv*)GetGlProc("glUniform2fv");
    glUniform3fv = (GlUniform3fv*)GetGlProc("glUniform3fv");
    glUniform4fv = (GlUniform4fv*)GetGlProc("glUniform4fv");
    glUniform1iv = (GlUniform1iv*)GetGlProc("glUniform1iv");
    glUniform2iv = (GlUniform2iv*)GetGlProc("glUniform2iv");
    glUniform3iv = (GlUniform3iv*)GetGlProc("glUniform3iv");
    glUniform4iv = (GlUniform4iv*)GetGlProc("glUniform4iv");
    glUniformMatrix2fv = (GlUniformMatrix2fv*)GetGlProc("glUniformMatrix2fv");
    glUniformMatrix3fv = (GlUniformMatrix3fv*)GetGlProc("glUniformMatrix3fv");
    glUniformMatrix4fv = (GlUniformMatrix4fv*)GetGlProc("glUniformMatrix4fv");

  glSwapControl = (GlSwapControl*)GetGlProc("wglSwapIntervalEXT");
}
